...
for aposta in range(0,1000):
    ...
    print('')
    print(f'Vamos sortear 2 dados e soma-los se der 7 ou 2 voce ganha o dobro do que aposto')
    print(f'Se der 6 voce perde o que aposto')
    print(f'Se der 10 vai empatar e voce não perde e nem ganha nada')
